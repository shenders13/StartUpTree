...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { stage_description: @stage.stage_description, stage_icon: @stage.stage_icon, stage_name: @stage.stage_name }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { stage_description: @stage.stage_description, stage_icon: @stage.stage_icon, stage_name: @stage.stage_name }
    assert_redirected_to stage_path(assigns(:stage))
  end
